                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="btn-group" role="group" aria-label="Second group">
                                            <a href="{{ url('admin/pro-course/edit', $data['id']) }}" class="btn btn-sm btn-primary edit-btn"><i class="fa fa-edit"></i></a>
...
@push('scripts')
    ...
    $('.sa-remove').on("click",function(){
        ...
        function(isConfirm){
          if (isConfirm) {
            window.location.href = "pro-course/delete/"+proCourseId;
            } else {
    ...
    {{-- <script type="text/javascript">
        $('input[id="toggle-block"]').change(function() {
            var pro-course_id = $(this).data('pro-course_id');
          ...
          $.ajax({
                type:'POST',
                dataType:'JSON',
                url:"{{route('admin.pro-course.updateStatus')}}",
                data:{ _token: CSRF_TOKEN, id:pro-course_id, status:check_status},
